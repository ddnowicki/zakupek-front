    ...
    >
      ...
      <CardContent>
        <div className="space-y-2">
          ...
          {list.storeName && <p className="text-sm text-muted-foreground">Sklep: {list.storeName}</p>}
          <p className="text-sm text-muted-foreground">Liczba produktów: {list.productsCount}</p>
        </div>
      </CardContent>
